...
export function ReaderView({work,chunks,related}:{work:Khassida;chunks:Chunk[];related:Pick<Khassida,"slug"|"title"|"arabic_title">[]}){
  ...
  return <main className="reader-shell">
    ...
    <section className="reader-main">
      ...
      <div className="reader-audio"><button disabled={!work.audio_url}><Icon name="play" size={22}/></button><span>0:00 / —</span><i/><Icon name="headphones" size={18}/><b>1.0x</b></div>
